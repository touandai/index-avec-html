...
<body>
     ...
     <main id="informations" class="container">
        <h4>Volkswagen Polo</h4>
         ...
         <div>Marque: <em>Volkswagen</em></div>
         <div>Modele : <em>Polo </em></div>
         <div>Année: <em>Fiat 2009</em></div>
         <div>Kilometrage:<em>130000</em></div>
         <div>Prix: <em>6500€</em></div>
         <div>Energie: <em>Diésel</em></div>
         <p> Date mise en circulation:<em>20/12/2005</em></div>
         </section>
     </main>
