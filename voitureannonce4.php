     ...
     <h4>Renault Clio</h4>
         <section id="carrousel" class="container">
            <div class="images-box">
                <img src="images/clio1.png" alt="voiture" id="slider_img" > 
            </div>
            <br>
         ...
         <div>Marque: <em>Renault</em></div>
         <div>Modele: <em>Clio 2</em></div>
         <div>Année: <em>2016</em></div>
         <div>Kilometrage:<em>95000</em></div>
         <div>Prix: <em>10000€</em></div>
...
<footer class="container">
    <a href="mentionslegales.html">Mentions légales</a><a href="horaireouverture.php"><marquee behavior="scroll">cliquer ici pour voir nos horaires d'ouverture</marquee></a><a href="#">Copyright</a>
        ...
        var images = ['clio1.png', 'clio2.png', 'clio3.png'];
        var i = 0 ;
